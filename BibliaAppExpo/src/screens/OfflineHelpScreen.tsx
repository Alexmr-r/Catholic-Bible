...
const getStyles = (colors: ThemeColors, isDarkMode: boolean) => StyleSheet.create({
  ...
  badge: {backgroundColor: isDarkMode ? `${colors.primary.DEFAULT}1A` : '#ECFDF5', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 12},
  badgeText: {fontSize: 9, fontWeight: '700', color: isDarkMode ? colors.primary.DEFAULT : '#059669', letterSpacing: 0.5},
  ...
  downloadButton: {flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: isDarkMode ? colors.background.dark : colors.cream, borderWidth: 1, borderColor: colors.ivory.border, borderRadius: 12, paddingVertical: 12, marginLeft: 28},
  downloadButtonText: {fontSize: 11, fontWeight: '700', color: isDarkMode ? colors.primary.DEFAULT : colors.gold.DEFAULT, letterSpacing: 1.5},
});
